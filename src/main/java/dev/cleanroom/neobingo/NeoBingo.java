...
import dev.cleanroom.neobingo.world.MatchPortalFallbackTicker;
...
public final class NeoBingo {
    ...
    public NeoBingo(IEventBus modBus, ModContainer container) {
        ...
        NeoForge.EVENT_BUS.addListener(MatchGameplayRules::onLivingDeath);
        NeoForge.EVENT_BUS.addListener(MatchGameplayRules::onLivingDrops);
        NeoForge.EVENT_BUS.addListener(MatchGameplayRules::onExperienceDrop);
        NeoForge.EVENT_BUS.addListener(MatchGameplayRules::onRespawn);
        NeoForge.EVENT_BUS.addListener(MatchPortalFallbackTicker::onPlayerTick);
